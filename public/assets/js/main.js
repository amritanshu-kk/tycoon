...
<div class="nav-wrapper">
    <a href="#!" class="brand-logo"><img src="assets/images/ofg.jpeg"></a>
...
<footer class="webintern-footer">
    <div class="footer-left">
      ...
      <a href="#" class="linkedin sub-footer-icon">
        ...
        <a href="https://www.linkedin.com/in/amritanshu-verma-the-alpha-king-79a145167/" class="git sub-footer-icon">
          <i class="fab fa-github"></i>
        </a>
        <a href="https://twitter.com/the__alpha_king" class="twitter sub-footer-icon">
          <i class="fab fa-twitter"></i>
        </a>
        <a href="mailto:amritanshu26dec@gmail.com? subject=Can you share your resume to me?" class="email-icon sub-footer-icon" >
        <i id="mail" class="fa fa-envelope" ></i>
        </a>
         
            <a href="https://www.instagram.com/the__alpha_king/" class="instagram sub-footer-icon">
            <i class="fab fa-instagram"></i>
          </a>  -->
        </div>
    </div>
    <div class="footer-right">
      <h6 class="display-7">Get in Touch with Sweety</h6>
